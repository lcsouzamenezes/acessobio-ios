...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "MatheusDomingos"
   spec.authors            = {"MatheusDomingos" => "matheus.domingos@unico.io", "Beatriz Monteiro" => "beatriz.monteiro@unico.io"}
  ...
  spec.source       = { :git => "https://github.com/acesso-io/acessobio-ios.git", :tag => "1.2.7" }
